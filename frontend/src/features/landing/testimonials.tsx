  ...
  const reviews = [
    {
      ...
      quote: "ZHĪ AI's GraphRAG engine transformed our knowledge retrieval. What used to take hours of manual documentation research now streams in sub-seconds with complete citation lineage.",
      stars: 5
    },
    {
      name: "Marcus Vance",
