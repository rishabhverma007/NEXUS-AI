...
export function FAQSection() {
  const faqs = [
    ...
    {
      id: "faq_2",
      question: "Can I run ZHĪ AI with local offline AI models?",
      answer: "Yes! ZHĪ AI natively supports local Ollama endpoints (such as Llama-3.3 and DeepSeek R1) alongside cloud APIs (OpenAI, Anthropic) with zero telemetry leakage."
    },
    {
      id: "faq_3",
