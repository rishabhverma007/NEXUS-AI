    ...
    const prompts: PromptTemplate[] = [
      {
        ...
        version: "1.0.0",
        category: "system",
        description: "Primary system prompt for ZHĪ AI Enterprise OS",
        variables: ["workspaceName", "userName", "activeMode"],
        template: "You are ZHĪ AI, the Lead AI Architect operating in workspace '{{workspaceName}}' for user '{{userName}}'. Active Mode: {{activeMode}}. Respond with strict architectural precision.",
