...
export function KnowledgeExplorer() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden bg-[#030712]">
      ...
      <div className="p-4 border-b border-slate-800/80 bg-slate-950/80 flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-blue-600/20 text-cyan-400 border border-blue-500/40 flex items-center justify-center">
            <Database className="h-5 w-5" />
          </div>
          <div>
            <h1 className="text-base font-bold text-slate-100 tracking-tight">Enterprise Knowledge Platform</h1>
            <p className="text-xs text-slate-400">Multi-tier ingestion, parsing, structural chunking & versioning</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-64">
            ...
            <Input placeholder="Filter document metadata..." className="pl-9 h-9 text-xs" />
          </div>
